...
Config.ClothingRooms = {
    ...
    [2] = {requiredJob = "ambulance", coords = vector3(314.12, -603.39, 43.29), cameraLocation = vector4(312.6, -602.78, 43.29, 247.49)}, -- Right double door in Hospital Map that is on QBCore GitHub
    ...
    [11] = {requiredJob = "redline", coords = vector3(-602.18, -913.92, 23.89), cameraLocation = vector4(-602.22, -917.11, 23.89, 1.67)},
}
